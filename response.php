                                ...
                                <div class="col-md-12">
                                    ...
                                    if($_GET["message"] == "Approved")
                                    {
                                      ...
                                      echo '<button type="button" class="close" data-dismiss="alert" aria-hidden="true"></button>';
                                       echo '<span><strong>Success!</strong> Approved</span>';
                                      echo '</div>';
                                   }
                                   else
                                   if($_GET["message"] == "Insufficient Fund")
                                   {
                                     echo '<div class="alert alert-danger alert-dismissable">';
                                    echo '<button type="button" class="close" data-dismiss="alert" aria-hidden="true"></button>';
                                   echo '<span><strong>Error!</strong> Insufficient Fund</span>';
                                   echo '</div>';
                                   }
                                   else
                                   if($_GET["message"] == "Failed 3D Authentication")
                                   {
                                     echo '<div class="alert alert-danger alert-dismissable">';
                                     echo '<button type="button" class="close" data-dismiss="alert" aria-hidden="true"></button>';
                                     echo '<span><strong>Error!</strong> Failed 3D Authentication</span>';
                                     echo '</div>';
                                   }
                                   ?>
